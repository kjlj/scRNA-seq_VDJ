...
The workflow for clone building in R is available [here](https://kjlj.github.io/scRNA-seq_VDJ/docs/building_b_cell_clones.html). This builds upon the Ig data generated from the combining IgBLAST and cellranger workflow. The RScript is available on [github](https://raw.githubusercontent.com/kjlj/scRNA-seq_VDJ/main/RScripts/building_b_cell_clones.R) in the [workshop respository](https://github.com/kjlj/scRNA-seq_VDJ).
...
Using the Ig dataset that was output from [previous workflow](https://kjlj.github.io/scRNA-seq_VDJ/docs/joining_cellranger_igblast.html) or the [joining_cellranger_igblast.R](https://raw.githubusercontent.com/kjlj/scRNA-seq_VDJ/main/RScripts/joining_cellranger_igblast.R) script. Loading this from githib repo, but can be loaded locally by changing to a file path rather than a URL.
```{r loading_datasets}
