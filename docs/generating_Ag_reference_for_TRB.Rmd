...
The epitope specificity of T cells may be inferred by matching TCRs to a reference database of clonotypes of known specificity. TCRs of known specificity will be collected from two sources, formatted for consistency with the clonotype labels used in the 10x data. 
