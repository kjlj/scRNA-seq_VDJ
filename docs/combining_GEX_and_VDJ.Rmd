...
The RScript for this workflow is available on [github](https://raw.githubusercontent.com/kjlj/scRNA-seq_VDJ/main/docs/combining_GEX_and_VDJ.Rmd) in the [workshop respository](https://github.com/kjlj/scRNA-seq_VDJ).
...
```{r b_cell_shm_panel, fig.height = 3.5, fig.width = 5, fig.align = "center"}
...
```{r b_cell_shm_panel2, fig.height = 3.5, fig.width = 5, fig.align = "center"}
...
```{r b_cell_shm_panel3, fig.height = 3.5, fig.width = 5, fig.align = "center"}
...
```{r b_cell_shm_panel4, fig.height = 8, fig.width = 11, fig.align = "center"}
...
```{r clonal_exp_panel2, fig.height = 5, fig.width = 7, fig.align = "center"}
##summarise
...
```{r clonal_exp_panel3, fig.height = 5, fig.width = 7, fig.align = "center"}
...
```{r clonal_exp_panel4, fig.height = 7, fig.width = 11, fig.align = "center"}
...
```{r clonal_exp_panel5, fig.height = 7, fig.width = 11, fig.align = "center"}
...
```{r clonal_exp_panel6, fig.height = 7, fig.width = 11, fig.align = "center"}
